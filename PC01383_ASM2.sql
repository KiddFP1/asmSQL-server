USE master
GO
CREATE DATABASE QLNHATRO_DangDMPC01383
GO
USE QLNHATRO_DangDMPC01383
GO
-- 1. Tạo bảng loainha
...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO NHATRO (MaLoaiNha, DienTich, GiaPhong, DiaChi, Quan, MoTa, NgayDangTin, MaNguoiDung)
        VALUES (@MaLoaiNha, @DienTich, @GiaPhong, @DiaChi, @Quan, @MoTa, @NgayDangTin, @MaNguoiDung)

        -- Trả về thông báo thành công
        PRINT N'Thêm thông tin nhà trọ thành công!'
    END TRY
    BEGIN CATCH
        -- Trả về thông báo lỗi
        RAISERROR(N'Lỗi khi thêm thông tin nhà trọ. Vui lòng kiểm tra lại các thông tin nhập vào!', 16, 1)
        RETURN
    END CATCH
END
...
-- thi hành
-- Không truyền đủ thông tin
EXEC sp_insert_NhaTro NULL, 50, NULL, N'Địa chỉ 123', N'Quận 7', 'Cho thuê', '2022-01-01', 1

-- Chèn thành công
EXEC sp_insert_NhaTro 1, 50, 1000000, N'Địa chỉ 123', N'Quận 8', 'Cho thuê dài hạn', '2022-01-01', 1
